  ...
  <div class="register-container">
    <div class="form-container">
      <v-card class="mx-auto pa-6 pb-2" elevation="20" max-width="448" rounded="lg">
        ...
        <v-card-subtitle style="text-align: center">Formulario para actualizar proveedores</v-card-subtitle>
        <div class="text-subtitle-1 text-medium-emphasis">Nombre</div>

        <v-text-field v-model="foundSupplier.nombre" density="compact" placeholder="Nombre" prepend-inner-icon="mdi-account-outline"
        ...
        <v-text-field v-model="foundSupplier.correo" density="compact" placeholder="Correo electrónico"
        ...
        <v-text-field v-model="foundSupplier.producto" density="compact" placeholder="Producto" prepend-inner-icon="mdi-cart-outline"
          variant="underlined" :rules="Rules"></v-text-field>
        ...
        <v-text-field v-model="foundSupplier.contacto" density="compact" placeholder="Número de contacto"
